...
var _this = this;
var loadTable = function (t) { return __awaiter(_this, void 0, void 0, function () {
    var users;
    var _this = this;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                users.forEach(function (user) {
                    ...
                    editBtn.setAttribute('href', "edit-user.html?id=".concat(user.id));
                    var textEditBtn = document.createTextNode('Editar');
                    editBtn.appendChild(textEditBtn);
                    var deleteBtn = document.createElement('button');
                    var textDeleteBtn = document.createTextNode('Eliminar');
                    ...
                    deleteBtn.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, deleteUser(user.id)];
                                case 1:
                                    _a.sent();
                                    loadTable(t);
                                    return [2 /*return*/];
                    ...
                    (_a = t === null || t === void 0 ? void 0 : t.querySelector('tbody')) === null || _a === void 0 ? void 0 : _a.appendChild(tr);
                });
                return [2 /*return*/];
        }
    });
