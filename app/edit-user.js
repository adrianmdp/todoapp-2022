...
var loadForm = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getUser(params.get('id'))];
            case 1:
                user = _a.sent();
                form === null || form === void 0 ? void 0 : form.name.value = user.name;
                form === null || form === void 0 ? void 0 : form.email.value = user.email;
                form === null || form === void 0 ? void 0 : form.pass.value = user.password;
                return [2 /*return*/];
        }
    });
}); };
